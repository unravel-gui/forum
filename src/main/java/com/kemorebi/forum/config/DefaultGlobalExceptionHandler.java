...
public class DefaultGlobalExceptionHandler {
    ...
    public R httpMessageNotReadableException(HttpMessageNotReadableException ex, HttpServletRequest request) {
        ...
        if (StrUtil.containsAny(message, "Could not read document:")) {
            ...
            return R.result(ExceptionCode.PARAM_EX.getCode(), " ", msg).setPath(request.getRequestURI());
        }
        return R.result(ExceptionCode.PARAM_EX.getCode(), " ", ExceptionCode.PARAM_EX.getMsg()).setPath(request.getRequestURI());
    }
    ...
    public R bindException(BindException ex, HttpServletRequest request) {
        ...
        try {
            ...
            if (StrUtil.isNotEmpty(msgs)) {
                return R.result(ExceptionCode.PARAM_EX.getCode(), " ", msgs).setPath(request.getRequestURI());
            }
        } catch (Exception ee) {
        }
        ...
        return R.result(ExceptionCode.PARAM_EX.getCode(), " ", msg.toString()).setPath(request.getRequestURI());
    }
    ...
    public R illegalStateException(IllegalStateException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.ILLEGALA_ARGUMENT_EX.getCode(), " ", ExceptionCode.ILLEGALA_ARGUMENT_EX.getMsg()).setPath(request.getRequestURI());
    }
    ...
    public R missingServletRequestParameterException(MissingServletRequestParameterException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.ILLEGALA_ARGUMENT_EX.getCode(), " ", msg.toString()).setPath(request.getRequestURI());
    }
    ...
    public R httpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException ex, HttpServletRequest request) {
        ...
        if (contentType != null) {
            ...
            return R.result(ExceptionCode.MEDIA_TYPE_EX.getCode(), " ", msg.toString()).setPath(request.getRequestURI());
        }
        return R.result(ExceptionCode.MEDIA_TYPE_EX.getCode(), " ", "无效的Content-Type类型").setPath(request.getRequestURI());
    }
    ...
    public R missingServletRequestPartException(MissingServletRequestPartException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.REQUIRED_FILE_PARAM_EX.getCode(), " ", ExceptionCode.REQUIRED_FILE_PARAM_EX.getMsg()).setPath(request.getRequestURI());
    }
    ...
    public R servletException(ServletException ex, HttpServletRequest request) {
        ...
        if (msg.equalsIgnoreCase(ex.getMessage())) {
            return R.result(ExceptionCode.REQUIRED_FILE_PARAM_EX.getCode(), " ", ExceptionCode.REQUIRED_FILE_PARAM_EX.getMsg());
        }
        return R.result(ExceptionCode.SYSTEM_BUSY.getCode(), " ", ex.getMessage()).setPath(request.getRequestURI());
    }
    ...
    public R<String> constraintViolationException(ConstraintViolationException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.BASE_VALID_PARAM.getCode(), " ", message).setPath(request.getRequestURI());
    }
    ...
    public R<String> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.METHOD_NOT_ALLOWED.getCode(), " ", ExceptionCode.METHOD_NOT_ALLOWED.getMsg()).setPath(request.getRequestURI());
    }
